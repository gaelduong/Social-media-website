		...
		if(mysqli_num_rows($data_query) > 0) {
			...
			if($count > $limit) 
				$str .= "<input type='hidden' class='nextPage' value='" . ($page + 1) . "'>
							<input type='hidden' class='noMorePosts' value='false' style='color:white'>";
			else 
				$str .= "<input type='hidden' class='noMorePosts' value='true'><p style='text-align: centre; color:white' class='noMorePostsText' > No more posts... </p>";
		}
